...
from autoregressive.models.generate_dual import generate_fq
...
def main(args):
    ...
    for _ in pbar:
        ...
        (index_sample_1, index_sample_2) = generate_fq(
            gpt_model, c_indices, latent_size ** 2,
            cfg_scale=[args.cfg_scale, args.cfg_scale],
        ...
        samples = vq_model.decode_code(index_sample_2, index_sample_1,
                                       qzshape, qzshape)  # output value is between [-1, 1]
