...
from autoregressive.models.far_dual import FAR_models
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for x1, x2, y in loader:
            ...
            assert z_indices_1.shape[0] == z_indices_2.shape[0] == c_indices.shape[0]
            with torch.cuda.amp.autocast(dtype=ptdtype):
                _, _, loss = model(cond_idx=c_indices,
                                   idx_1=z_indices_1, idx_2=z_indices_2,
                                   targets_1=z_indices_1, targets_2=z_indices_2)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpt-model", type=str, choices=list(FAR_models.keys()))
