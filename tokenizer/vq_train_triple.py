...
from tokenizer.vq_loss import VQLoss_triple_codebook
...
def main(args):
    ...
    vq_loss = VQLoss_triple_codebook(
        ...
        for x, y in loader:
            ...
            with torch.cuda.amp.autocast(dtype=ptdtype):
                recons_imgs, \
                    ...
                    disentangle_loss, semantic_feat_mid, semantic_feat_high = vq_model(imgs)
                loss_gen = vq_loss(codebook_loss_vis, codebook_loss_sem_mid, codebook_loss_sem_high,
                                   imgs, recons_imgs,
                                   disentangle_loss,
            ...
            with torch.cuda.amp.autocast(dtype=ptdtype):
                loss_disc = vq_loss(codebook_loss_vis, codebook_loss_sem_mid, codebook_loss_sem_high,
                                    imgs, recons_imgs,
                                    disentangle_loss,
                                    semantic_feat_mid, semantic_feat_high,
