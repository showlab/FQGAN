...
def main(args):
    ...
    for x, _ in loader:
        ...
        with torch.no_grad():
            ...
            latent_sem, latent_vis, [_, _, indices_sem], [_, _, indices_vis] = vq_model.encode(x)
            samples = vq_model.decode_code(indices_sem, indices_vis, latent_sem.shape, latent_vis.shape)   # output value is between [-1, 1]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--codebook-size-sem", type=int, default=0, help="codebook size for vector quantization")
    parser.add_argument("--codebook-embed-dim", type=int, default=8, help="codebook dimension for vector quantization")
    parser.add_argument("--codebook-embed-dim-sem", type=int, default=0, help="codebook dimension for vector quantization")
    parser.add_argument("--image-size", type=int, choices=[256, 384, 512], default=256)
    parser.add_argument("--image-size-eval", type=int, choices=[256, 384, 512], default=256)
    parser.add_argument("--sample-dir", type=str, default="reconstructions")
    parser.add_argument("--folder-name", type=str, default="default_recon")
