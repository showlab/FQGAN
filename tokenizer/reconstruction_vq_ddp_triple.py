...
def main(args):
    ...
    for x, _ in loader:
        ...
        with torch.no_grad():
            ...
            [_, _, indices_vis], [_, _, indices_sem_mid], [_, _, indices_sem_high] = vq_model.encode(x)
            samples = vq_model.decode_code(indices_vis, indices_sem_mid, indices_sem_high,
                                           latent_vis.shape, latent_sem_mid.shape, latent_sem_high.shape)   # output value is between [-1, 1]
